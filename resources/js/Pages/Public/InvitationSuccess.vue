    ...
    >
        ...
        >
            <div class="flex flex-col items-center gap-5 px-8 py-12 sm:px-12">
                ...
                >
                    <i class="pi pi-check-circle text-3xl" style="color: #4ade80" />
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <p class="text-sm leading-7" style="color: var(--text-color-secondary)">
                        Twoje dane zostały przesłane do administratora platformy. Po weryfikacji
                        i aktywacji konta otrzymasz e-mail na adres
                ...
                >
                    ...
                    Aktywacja może zająć do 24 godzin.
                </div>
            </div>
        </div>
    </div>
