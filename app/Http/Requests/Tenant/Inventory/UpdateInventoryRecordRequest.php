...
final class UpdateInventoryRecordRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'format' => ['sometimes', 'required', 'string', Rule::enum(DiscFormatEnum::class)],
            'condition' => ['sometimes', 'required', 'string', Rule::enum(DiscConditionEnum::class)],
    ...
    public function messages(): array
    {
        return [
            ...
            'purchase_price_per_unit.numeric' => 'Cena zakupu za szt. musi być liczbą.',
            'purchase_price_per_unit.min' => 'Cena zakupu za szt. nie może być ujemna.',
            'purchase_price_per_unit.max' => 'Cena zakupu za szt. nie może przekraczać 999 999,99 zł.',
